...
import org.lqx.framework.modules.sys.entity.SysLog;
import org.lqx.framework.modules.sys.entity.SysUser;
import org.lqx.framework.modules.sys.service.SysLogService;
...
public class OperLogAspect {
    ...
    /**
     * 在注解的位置切入代码
     * 表示匹配org.lqx.framework.modules*.controller 包下的所有方法
     */

    @Pointcut("execution(* org.lqx.framework.modules.*.controller.*.*(..))")
